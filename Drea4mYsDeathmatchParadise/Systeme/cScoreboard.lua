...
function Scoreboard.dxDraw()
    ...
    dxDrawText("Dre4mY's Deathmatch", 613*(x/1920), 297*(y/1080), 1307*(x/1920), 342, tocolor(255, 255, 255, 255), 1*(y/1080), ScoreboardFont, "center", "center", false, false, false, false, false)
