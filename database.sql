...
(1, 'Dre4mYs DM', 99, '', '', 1, 1, 'Deathmatch #1'),
(2, 'Dre4mYs DM', 99, '', '', 1, 2, 'Deathmatch #2'),
(3, 'Dre4mYs DM', 99, '', '', 1, 3, 'Deathmatch #3')
...
CREATE TABLE `userdata` (
  ...
  `Status` varchar(50) NOT NULL DEFAULT 'BDM-Spieler',
